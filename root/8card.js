...
//Card 5 Play area queries
const card5Front = document.querySelector('#card5Front')
const card5Back = document.querySelector('#card5Back')
const card5 = document.querySelector('#card5')

//Card 6 Play area queries
const card6Front = document.querySelector('#card6Front')
const card6Back = document.querySelector('#card6Back')
const card6 = document.querySelector('#card6')

//Card 7 Play area queries
const card7Front = document.querySelector('#card7Front')
const card7Back = document.querySelector('#card7Back')
const card7 = document.querySelector('#card7')

//Card 8 Play area queries
const card8Front = document.querySelector('#card8Front')
const card8Back = document.querySelector('#card8Back')
...
const createPlayArea = cards => {
    ...
    card5Front.innerHTML = 
    `<img src="${chosen[4].front}" class="card__face" id="card5Front">`
    card5Back.innerHTML =
    `<img src="${chosen[4].back}" class="card__face" id="card5Back">`
    card6Front.innerHTML = 
    `<img src="${chosen[5].front}" class="card__face" id="card6Front">`
    card6Back.innerHTML =
    `<img src="${chosen[5].back}" class="card__face" id="card6Back">`
    card7Front.innerHTML = 
    `<img src="${chosen[6].front}" class="card__face" id="card7Front">`
    card7Back.innerHTML =
    `<img src="${chosen[6].back}" class="card__face" id="card7Back">`
    card8Front.innerHTML = 
    `<img src="${chosen[7].front}" class="card__face" id="card8Front">`
    card8Back.innerHTML =
    `<img src="${chosen[7].back}" class="card__face" id="card8Back">`
}
...
const softReset = () => {
    ...
    card5.className = 'card__inner'
    card6.className = 'card__inner'
    card7.className = 'card__inner'
    card8.className = 'card__inner'
    flipCounter = 0
    id1 = ''
    id2 = ''
}
...
card5.addEventListener('click', card5Flip)
card6.addEventListener('click', card6Flip)
card7.addEventListener('click', card7Flip)
card8.addEventListener('click', card8Flip)
